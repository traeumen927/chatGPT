...
final class ChatMessageCell: UITableViewCell {
    ...
    private var userImageWidthConstraint: Constraint?
    ...
    private func layout() {
        ...
        userImageCollectionView.snp.makeConstraints { make in
            ...
            userImageWidthConstraint = make.width.equalTo(0).priority(999).constraint
    ...
    private func bind() {
        userImageCollectionView.rx.observe(CGSize.self, "contentSize")
            ...
            .bind { [weak self] size in
                ...
                let maxWidth = UIScreen.main.bounds.width * 0.8 - 16
                self.userImageWidthConstraint?.update(offset: min(size.width, maxWidth))
    ...
    override func prepareForReuse() {
        ...
        userImageWidthConstraint?.update(offset: 0)
...
extension ChatMessageCell: UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        userImageUrls.count
    }

    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "RemoteImageCollectionCell", for: indexPath) as! RemoteImageCollectionCell
